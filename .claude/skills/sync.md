...
3. Check for any remote branches that aren't `main`. For each one:
   ...
   c. Move any new files that landed outside the `spike/` folder (and aren't part of the core project structure like `src/`, `scripts/`, `reference/`, `CLAUDE.md`, `.claude/`) into the `spike/` folder.
