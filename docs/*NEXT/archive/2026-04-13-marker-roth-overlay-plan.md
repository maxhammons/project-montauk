...
> Archived 2026-05-22. The marker-prior work is superseded by the current
> validation framework, and the Roth overlay implementation exists in
> `scripts/diagnostics/roth_overlay.py` with spike-run `overlay_report.json`
> support.

> **Status (2026-04-13):** The marker-prior section of this plan was
> **superseded** by the 2026-04-13 charter revision. Marker alignment is now a
> first-class validation gate at every tier, not a +/-5% soft-prior nudge on raw
> fitness. See `docs/validation-philosophy.md` and `docs/charter-appendix.md`
> for the current framing. The Roth overlay sections were later implemented and
