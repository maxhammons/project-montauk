...
> **Read first**: [spirit-guide.md](../../../Montauk%202.0/spirit-guide.md) — problem framing, intent, governing principles, and non-goals. This plan is the "what" and "how"; the spirit guide is the "why." If a task here seems to conflict with the spirit guide, trust the spirit guide and flag the conflict.
