...
*Run this after execution is "done" to confirm every phase actually landed correctly. Companion to [Montauk 2.0 - Master Plan.md](./Montauk%202.0%20-%20Master%20Plan.md). Read [spirit-guide.md](../../../Montauk%202.0/spirit-guide.md) first for intent.*
