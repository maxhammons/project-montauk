...
GRIDS = {
    ...
    "atr_ratio_vix_rebound": {  # ATR/VIX near-miss with earlier rebound repair entries
        "atr_short": [7, 14],
        "atr_long": [75, 100],
        "fast_ema": [20, 30, 50],
        "slow_ema": [100, 200],
        "rsi_len": [14],
        "atr_ratio_entry": [1.0],
        "rebound_ratio_max": [1.2],
        "drawdown_lookback": [80, 120],
        "drawdown_pct": [15.0, 20.0],
        "repair_slope": [3],
        "rsi_reclaim": [40.0],
        "vix_arm": [28.0],
        "vix_exit_level": [30.0],
        "vix_spike_pct": [50.0],
        "death_buffer_pct": [0.0, 0.5],
        "death_persist": [8, 10, 12],
        "cooldown": [5],
    },
    ...
    "rsi_rebound_participation": {  # bounded rebound-participation repair grid
        "rsi_len": [7, 14],
        "fast_len": [20, 30, 50],
        "trend_len": [100, 150, 200],
        "entry_rsi": [35.0, 40.0],
        "participation_rsi": [45.0, 50.0],
        "panic_rsi": [20.0, 25.0],
        "drawdown_lookback": [40, 80],
        "drawdown_pct": [10.0, 15.0],
        "slope_lookback": [3, 5],
        "confirm_bars": [1, 2],
        "exit_buffer_pct": [3.0, 5.0],
        "below_persist": [3, 5],
        "vix_arm": [28.0],
        "cooldown": [5],
    },
    ...
    "gc_vjatr_timing_repair": {  # minimal post-drawdown re-entry timing module
        "fast_ema": [140],
        "slow_ema": [160],
        "slope_window": [1],
        "entry_bars": [2],
        ...
        "repair_len": [20, 30, 50],
        "rsi_len": [7, 14, 21],
        "drawdown_lookback": [40, 60, 80, 100],
        "drawdown_pct": [10.0, 15.0, 20.0, 25.0],
        "repair_slope": [1, 3, 5],
        "rsi_floor": [35.0, 40.0, 45.0],
        "vix_ceiling": [30.0, 40.0, 50.0],
    },
    "gc_vjatr_reclaimer_timing": {  # reclaimer economics plus narrow timing repair
        "fast_ema": [140],
        "slow_ema": [160],
        "slope_window": [1],
        "entry_bars": [2],
        ...
        "rsi_reclaim": [45.0],
        "vol_ratio_max": [0.85],
        "timing_repair_len": [20, 30],
        "timing_rsi_len": [7],
        "timing_drawdown_lookback": [40, 60, 80],
        "timing_drawdown_pct": [25.0, 30.0],
        "timing_repair_slope": [1, 3],
        "timing_rsi_floor": [45.0, 50.0],
        "timing_vix_ceiling": [35.0, 40.0],
        "timing_trend_len": [50, 100],
        "timing_vol_short": [10],
        "timing_vol_long": [60],
        "timing_vol_ratio_max": [0.70, 0.80],
    },
