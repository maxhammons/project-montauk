# Spike Report — Run 019 (2026-04-10)

**Run:** 0.0h | 26 evals | 24 generations | 1 strategies
...
|---|----------|-----------|---------|--------|--------|--------|
| 1 | montauk_821 | 13.5444 | 13.8557 | 0.275 | 48.614x | 79 |

## Top 3 — Details

### #1: montauk_821

**Discovery:** 13.5444 | **Marker alignment:** 0.275 | **Fitness:** 13.8557

**Fitness:** 13.8557 | **Regime Score:** 0.404 (bull=0.223, bear=0.586) | **HHI:** 0.196

**CAGR:** 17.2% | **Max DD:** 52.7% | **MAR:** 0.326 | **vs B&H:** 48.614x | **Params:** 10
...
**Trades:** 79 total (2.9/yr) | **Win rate:** 77.2%

**Validation:** FAIL | **Composite:** 0.000 | **Pine Eligible:** True
**Warnings:** trades_per_param=7.90 in soft-warning band; n_params=10 exceeds regime_transitions=7; strategy family still unconverged in leaderboard history; concentration nearing limit: dom=2.63x; composite_confidence=0.000 < 0.70
**Hard fails:** selection_bias: observed_rs=0.4043 expected_max=0.7607 deflated=0.0000; meta robustness: only 53.6% within 20% of baseline

**Marker detail:** accuracy=0.437 | f1=0.426 | transition_timing=0.238 | window=1999-10-27 -> 2025-10-30

**Exit reasons:** E: 70, Q: 6, A: 2, End of Data: 1
...
- **This run's best:** montauk_821 (fitness 13.8557)
- No improvement (-79.2%)
...
- New unique configs tested: 26
- Configs reused from cache: 70
- Total configs in history: 66,270
