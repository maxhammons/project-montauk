# Spike Report — Run 032 (2026-04-13)

**Run:** 0.1h | 6,358 evals | 134 generations | 19 strategies
...
- Candidate Pine: /Users/Max.Hammons/Documents/local-sandbox/Project Montauk/spike/runs/032/candidate_strategy.txt
- Overlay report: /Users/Max.Hammons/Documents/local-sandbox/Project Montauk/spike/runs/032/overlay_report.json
...
|---|----------|------|-------------|--------|---------|--------|
| 1 | momentum_stayer | T2 | 157.956x | 0.463 | 38.8915 | 49 |
| 2 | breakout | T2 | 131.427x | 0.455 | 38.2378 | 35 |
| 3 | ichimoku_trend | T2 | 69.443x | 0.429 | 32.6651 | 89 |
| 4 | montauk_821 | T2 | 73.317x | 0.452 | 28.4158 | 111 |
| 5 | rsi_vol_regime | T2 | 62.212x | 0.303 | 27.5765 | 99 |
| 6 | rsi_regime | T2 | 99.314x | 0.319 | 27.0515 | 40 |
| 7 | vix_trend_regime | T2 | 59.070x | 0.448 | 24.6744 | 70 |
| 8 | slope_persistence | T2 | 56.685x | 0.475 | 21.9321 | 73 |
| 9 | ema_regime | T2 | 130.214x | 0.518 | 21.2727 | 24 |
| 10 | dual_momentum | T2 | 49.762x | 0.384 | 17.1764 | 66 |
...
|---|----------|------|-------------|----|------|--------|-----|---------|--------|------|
| 1 | golden_cross_slope | T0 | 4.041x | 0.655 | 7.2% | 85.1% | 0.084 | 0.9692 | CONVERGED | 2026-04-13 |

## Session Stats

- New unique configs tested: 6,358
- Configs reused from cache: 33,842
- Total configs in history: 268,330
