# Spike Report — Run 038 (2026-04-15)

**Run:** 0.0h | 1,962 evals | 1 generations | 20 strategies

## Validation Summary

- Raw candidates: 20
- Pre-tier3 pass: 18
- Fully validated pass: 14
- Tier3 warns: 2
- Failed validation: 4
- Tier3 budget: 0.5m @ pop 12 | N_eff: 300
- Champion: gc_strict_vix (fitness 16.0205, composite 0.839)
- Trade ledger: /Users/Max.Hammons/Documents/local-sandbox/Project Montauk/spike/runs/038/trade_ledger.json
- Signal series: /Users/Max.Hammons/Documents/local-sandbox/Project Montauk/spike/runs/038/signal_series.json
- Equity curve: /Users/Max.Hammons/Documents/local-sandbox/Project Montauk/spike/runs/038/equity_curve.json
- Validation summary: /Users/Max.Hammons/Documents/local-sandbox/Project Montauk/spike/runs/038/validation_summary.json
- Dashboard data: /Users/Max.Hammons/Documents/local-sandbox/Project Montauk/spike/runs/038/dashboard_data.json
- Overlay report: /Users/Max.Hammons/Documents/local-sandbox/Project Montauk/spike/runs/038/overlay_report.json
...
| 6 | atr_ratio_vix | T1 | 9.495x| 0.564 | 0.462 | 23.8% | 67.3% | 0.353 | 27 | 4 | 3.3191 |
| 7 | willr_recovery_trend | T1 | 8.350x| 0.537 | 0.493 | 23.3% | 65.3% | 0.356 | 30 | 4 | 3.1311 |
| 8 | golden_cross_slope | T1 | 7.915x| 0.464 | 0.495 | 23.1% | 65.3% | 0.353 | 34 | 4 | 2.9741 |
| 9 | bb_width_regime | T1 | 8.732x| 0.529 | 0.483 | 23.4% | 70.0% | 0.335 | 32 | 4 | 2.9621 |
| 10 | atr_ratio_trend | T1 | 7.557x| 0.512 | 0.492 | 22.9% | 69.3% | 0.331 | 30 | 4 | 2.6245 |
...
| 5 | momentum_stayer | T2 | 25.374x| 0.544 | 10.8903 | 28 |
| 5 | gc_precross | T1 | 35.745x| 0.426 | 10.3434 | 40 |
| 7 | ema_regime | T2 | 11.621x| 0.454 | 3.5094 | 35 |
| 8 | bb_cci_combo | T1 | 9.304x| 0.503 | 3.4071 | 32 |
| 6 | atr_ratio_vix | T1 | 9.495x| 0.564 | 3.3191 | 27 |
| 7 | willr_recovery_trend | T1 | 8.350x| 0.537 | 3.1311 | 30 |
...
| 7 | gc_precross_strict | T1 | 44.050x| 0.521 | 29.6% | 75.1% | 0.395 | 13.9503 | active | 2026-04-15 |
...
| 12 | gc_precross_strict | T1 | 31.638x| 0.514 | 27.9% | 75.1% | 0.372 | 11.8377 | active | 2026-04-14 |
| 13 | gc_precross_roc | T1 | 44.438x| 0.513 | 29.7% | 82.3% | 0.361 | 11.7243 | active | 2026-04-15 |
...
| 18 | gc_precross_strict | T1 | 34.633x| 0.533 | 28.3% | 82.0% | 0.345 | 10.9672 | active | 2026-04-14 |
...
- New unique configs tested: 1,962
- Configs reused from cache: 798
- Total configs in history: 12,837
