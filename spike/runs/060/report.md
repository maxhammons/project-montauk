# Spike Report — Run 060 (2026-04-15)

**Run:** 1.0h | 104,883 evals | 915 generations | 20 strategies

## Validation Summary

- Raw candidates: 20
- Pre-tier3 pass: 14
- Fully validated pass: 9
- Tier3 warns: 0
- Failed validation: 11
- Tier3 budget: 1.5m @ pop 20 | N_eff: 300
- Champion: gc_strict_vix (fitness 28.0807, composite 0.833)
- Trade ledger: /Users/Max.Hammons/Documents/local-sandbox/Project Montauk/spike/runs/060/trade_ledger.json
- Signal series: /Users/Max.Hammons/Documents/local-sandbox/Project Montauk/spike/runs/060/signal_series.json
- Equity curve: /Users/Max.Hammons/Documents/local-sandbox/Project Montauk/spike/runs/060/equity_curve.json
- Validation summary: /Users/Max.Hammons/Documents/local-sandbox/Project Montauk/spike/runs/060/validation_summary.json
- Dashboard data: /Users/Max.Hammons/Documents/local-sandbox/Project Montauk/spike/runs/060/dashboard_data.json
- Overlay report: /Users/Max.Hammons/Documents/local-sandbox/Project Montauk/spike/runs/060/overlay_report.json
...
| 9 | cci_willr_combo | T1 | 11.909x| 0.488 | 0.499 | 24.8% | 65.3% | 0.380 | 33 | 4 | 4.4940 |

## Discovery Top 10 (Pre-Validation)

| # | Strategy | Tier | Share Mult. | Marker | Fitness | Trades |
|---|----------|------|-------------|--------|---------|--------|
| 1 | rsi_vol_regime | T2 | 108.721x| 0.525 | 49.5373 | 18 |
| 2 | montauk_821 | T2 | 153.433x| 0.687 | 43.6818 | 44 |
...
| 9 | momentum_stayer | T2 | 33.389x| 0.587 | 14.7090 | 25 |
| 10 | rsi_regime | T2 | 36.268x| 0.356 | 9.6877 | 41 |
...
|---|----------|------|-------------|----|------|--------|-----|---------|--------|------|
| 1 | gc_strict_vix | T1 | 77.287x| 0.515 | 32.1% | 68.2% | 0.471 | 28.0807 | CONVERGED | 2026-04-15 |
| 2 | gc_pre_vix | T1 | 70.551x| 0.515 | 31.8% | 68.2% | 0.465 | 25.6359 | CONVERGED | 2026-04-15 |
| 3 | gc_precross_roc | T1 | 85.856x| 0.518 | 32.5% | 80.2% | 0.406 | 24.0261 | CONVERGED | 2026-04-15 |
| 4 | gc_strict_vix | T1 | 49.761x| 0.509 | 29.7% | 68.2% | 0.435 | 17.9653 | CONVERGED | 2026-04-14 |
| 5 | gc_pre_vix | T1 | 47.817x| 0.511 | 29.5% | 68.2% | 0.433 | 17.2920 | CONVERGED | 2026-04-14 |
| 6 | gc_pre_vix | T1 | 45.748x| 0.510 | 29.4% | 68.2% | 0.430 | 16.5369 | CONVERGED | 2026-04-14 |
| 7 | gc_pre_vix | T1 | 45.296x| 0.510 | 29.3% | 68.2% | 0.430 | 16.3735 | CONVERGED | 2026-04-14 |
| 8 | gc_precross_strict | T1 | 50.708x| 0.521 | 30.4% | 75.1% | 0.405 | 16.0589 | CONVERGED | 2026-04-15 |
| 9 | gc_strict_vix | T1 | 41.370x| 0.510 | 29.0% | 68.2% | 0.424 | 14.9451 | CONVERGED | 2026-04-14 |
| 10 | gc_precross | T1 | 46.428x| 0.521 | 30.1% | 75.1% | 0.401 | 14.7093 | CONVERGED | 2026-04-15 |
| 11 | gc_pre_vix | T1 | 48.887x| 0.518 | 29.6% | 78.9% | 0.376 | 14.1318 | CONVERGED | 2026-04-14 |
| 12 | gc_precross_strict | T1 | 44.050x| 0.521 | 29.6% | 75.1% | 0.395 | 13.9503 | CONVERGED | 2026-04-15 |
| 13 | gc_precross | T1 | 40.084x| 0.519 | 28.8% | 78.9% | 0.366 | 13.7289 | CONVERGED | 2026-04-14 |
| 14 | gc_pre_vix | T1 | 40.210x| 0.503 | 28.9% | 71.3% | 0.405 | 13.5687 | CONVERGED | 2026-04-14 |
| 15 | gc_pre_vix | T1 | 37.272x| 0.504 | 28.6% | 70.5% | 0.405 | 12.7890 | CONVERGED | 2026-04-14 |
| 16 | gc_strict_vix | T1 | 37.533x| 0.507 | 28.6% | 71.5% | 0.400 | 12.6550 | CONVERGED | 2026-04-14 |
| 17 | gc_precross_strict | T1 | 31.638x| 0.514 | 27.9% | 75.1% | 0.372 | 11.8377 | CONVERGED | 2026-04-14 |
| 18 | gc_precross_roc | T1 | 44.438x| 0.513 | 29.7% | 82.3% | 0.361 | 11.7243 | CONVERGED | 2026-04-15 |
| 19 | gc_strict_vix | T1 | 42.239x| 0.532 | 29.0% | 82.0% | 0.354 | 11.4529 | CONVERGED | 2026-04-14 |
| 20 | gc_strict_vix | T1 | 33.831x| 0.506 | 28.2% | 71.3% | 0.395 | 11.4514 | CONVERGED | 2026-04-14 |

## Session Stats

- New unique configs tested: 104,883
- Configs reused from cache: 2,713,317
- Total configs in history: 187,150
