...
def main() -> None:
    ...
    payload = {
        "metadata": {
            ...
            "distribution_cash": round(float(result.distribution_cash), 6),
            "bah_distribution_cash": round(float(result.bah_distribution_cash), 6),
            "synthetic_financing_drag_bps_annual": 189.7,
        },
