...
def build_strategy_entry(rank: int,
    ...
    out: dict[str, Any] = {
        ...
        "overall_confidence": (confidence_v2 or {}).get("overall_confidence"),
        "overall_confidence_100": (confidence_v2 or {}).get("overall_confidence_100"),
        "future_confidence": (confidence_v2 or {}).get("future_confidence"),
        "future_confidence_100": (confidence_v2 or {}).get("future_confidence_100"),
        "trust": (confidence_v2 or {}).get("trust"),
        "trust_100": (confidence_v2 or {}).get("trust_100"),
        "future_confidence_components": (confidence_v2 or {}).get("future_confidence_components"),
        "trust_components": (confidence_v2 or {}).get("trust_components"),
        # Backward-compatible aliases for previous Confidence v2 naming.
